...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(h1, "class", "svelte-1uqf6cs");
			add_location(h1, file, 5, 1, 47);
			add_location(p0, file, 7, 1, 66);
			add_location(p1, file, 8, 1, 78);
			add_location(p2, file, 9, 1, 156);
			add_location(p3, file, 10, 1, 235);
			add_location(p4, file, 11, 1, 294);
			add_location(p5, file, 12, 1, 334);
			add_location(p6, file, 13, 1, 346);
			add_location(p7, file, 14, 1, 560);
			add_location(p8, file, 15, 1, 643);
			add_location(p9, file, 16, 4, 658);
			add_location(p10, file, 17, 1, 862);
			add_location(p11, file, 18, 1, 1066);
			add_location(p12, file, 19, 1, 1129);
			add_location(b, file, 20, 1, 1141);
			add_location(p13, file, 21, 1, 1164);
			add_location(p14, file, 22, 1, 1190);
			attr_dev(main, "class", "svelte-1uqf6cs");
